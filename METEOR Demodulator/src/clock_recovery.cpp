...
ClockRecovery::ClockRecovery(float omega, float gain_omega, float mu, float gain_mu, float omega_limit)
{
  mu_ = mu;
  omega_ = omega;
  muGain_ = gain_mu;
  omegaGain_ = gain_omega;

  // Allow 0.2% deviation from expected omega.
  omegaMin_ = omega_ - omega_limit * omega_;
  omegaMax_ = omega_ + omega_limit * omega_;
